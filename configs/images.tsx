const images = {
  ...
  shipmentsIconInactive: require("../assets/images/shipmentsInactive.png"),
  scanIconActive: require("../assets/images/scanActive.png"),
  scanIconInActive: require("../assets/images/scanInactive.png"),
  walletIconActive: require("../assets/images/walletActive.png"),
